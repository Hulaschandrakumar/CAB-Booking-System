...
def RegisterPage():
    ...
    canvas.create_rectangle(90,100,430,550,fill="gray",outline="white")
    ...
    Loginbutton=Button(canvas,text="Login",fg="white",bg="gray",bd=0,font=("Arial",13,'bold'),command=loginpage)
    ...
    if secians!="" and seciq!="" and usr!="" and pwd!="":
        ...
        if flag:
             ...
             for i in users:
                 f.write(i)
             f.close()
             messagebox.showinfo("Successfull", "Password Reset Successfull ")
        else:
...
def feedpage():
    ...
    canvas.create_text(683,100,text="Feedback" ,fill="White",font=("Arial/bold",25,'underline'))
    canvas.create_text(400,300,text="Rating:" ,fill="Yellow",font=("Arial",13))
    canvas.create_text(400,450,text="Review:" ,fill="yellow",font=("Arial",13))
    var = StringVar(root)
    var.set(1)
    secmenu=  ttk.Combobox(root, width=30,height=20,textvariable=var)
    secmenu['values'] =list(range(1,6))
    secmenu['state'] = 'readonly'
    feedEntry=Text(canvas, height=10, width=65,fg='Black',bg="yellow",bd=4,font=("Arial",10,'italic'))
...
def forgotpage():
    ...
    backgroundIMG=PhotoImage(file="background.gif")
    canvas.create_image(0,0,image=backgroundIMG,anchor=NW)
    canvas.create_rectangle(90,150,430,550,fill="gray",outline="white")
    ...
    userEntered=Entry(canvas,bg="white",bd=4,fg='gray',font=("Arial",13,'bold'))
    ...
    Resetbutton=Button(canvas,text="Reset Password",width=15,fg="white",bg="gray",font=("Arial",13,'bold'),command=forgotpass)
...
def cabbook():
    ...
    canvas.create_rectangle(0,0,1366,200,fill="light pink",outline="pink")
    canvas.create_rectangle(590,200,890,500,fill="pink")
    ...
    bookbutton=Button(canvas,text="book Ride",width=10,fg="BLACK",bg="#FFFF33",font=("Arial",13,'bold'),command=book)
    canvas.create_window(750,450,window=bookbutton)
    canvas.create_text(1200,50,text="Welcome "+loggedname,font=("Arial",15),fill="#000")
    canvas.pack()
    detbutton=Button(canvas,text="View Past booking",width=15,fg="#000",bg="light pink",bd=0,font=("Arial",13,'bold'),command=viewbooking)
    canvas.create_window(1200,80,window=detbutton)
    lobutton=Button(canvas,text="Logout",width=15,fg="#000",bg="light pink",bd=0,font=("Arial",13,'bold'),command=loginpage)
    canvas.create_window(1200,180,window=lobutton)
    cpbutton=Button(canvas,text="Change your Password",width=20,fg="#000",bg="light pink",bd=0,font=("Arial",13,'bold'),command=changepasswordpage)
    canvas.create_window(1200,110,window=cpbutton)
    revbutton=Button(canvas,text="Review",width=20,fg="#000",bg="light pink",bd=0,font=("Arial",13,'bold'),command=feedpage)
...
def adminloginpage():
    ...
    sbutton=Button(canvas,text="user section",width=10,fg="white",bg="gray",bd=0,font=("Arial",13,'bold'),command=loginpage)
...
def changepasswordpage():
    ...
    backgroundIMG=PhotoImage(file="background.gif")
    canvas.create_image(0,0,image=backgroundIMG,anchor=NW)
    canvas.create_rectangle(600,150,1000,550,fill="gray",outline="white")
    ...
    oldpassEntered=Entry(canvas,bg="white",bd=4,fg='gray',font=("Arial",13,'bold'),show="*")
    ...
    backbutton=Button(canvas,text="Back",fg="white",bg="gray",bd=0,font=("Arial",13,'bold'),command=gotocpage)
...
def loginpage():
    ...
    canvas.create_window(300,300,window=userEntered)
    canvas.create_window(300,350,window=passEntered)
    Loginbutton=Button(canvas,text="Login",width=10,fg="black",bg="yellow",font=("Arial",13,'bold'),command=validate)
    canvas.create_window(200,450,window=Loginbutton)
    Regbutton=Button(canvas,text="Register",fg="black",bg="gray",bd=0,font=("Arial",13,'bold'),command=RegisterPage)
    canvas.create_window(320,450,window=Regbutton)
    forgbutton=Button(canvas,text="Forgot Password",fg="white",bg="gray",bd=0,font=("Arial",10,'underline'),command=forgotpage)
    canvas.create_window(280,380,window=forgbutton)
    abutton=Button(canvas,text="Admin Login",fg="white",bg="gray",bd=0,font=("Arial",10,'underline'),command=adminloginpage)
